        ...
        <>
            ...
            <Stage step={ step }>
                ...
                <Scene onClick={ toggleCurrentStep(4) }>
                    ...
                    <Transform scale={ 1.5 } />
                    <Entry
                        dot={ Entry.DotPosition.TopRight }
                        style={{ minWidth: 256 }}>
                        <Entry.Text>
                            <strong>PBS Broadway-musical documentary:</strong>{ ' ' }
                            Noble but misbegotten—and too many of the talking
                            heads are dead.
                        </Entry.Text>
                    </Entry>
                </Scene>
                ...
                <Scene onClick={ toggleCurrentStep(6) }>
                    ...
                    <Entry dot={ Entry.DotPosition.TopLeft }>
                        <Entry.Text>
                            <strong>Tucker Carlson:</strong> His smugness
                            boomerangs.
                        </Entry.Text>
                    </Entry>
                </Scene>
                ...
                <Scene onClick={ toggleCurrentStep(8) }>
                    ...
                    <Entry dot={ Entry.DotPosition.Top }>
                        <Entry.Text>
                            <strong>Bob Dylan</strong> bio. Poignant!
                            Idiosyncratic! And full of New York trivia.
                        </Entry.Text>
                        <Image src={ dylan } />
                    </Entry>
                </Scene>
                ...
                <Scene onClick={ toggleCurrentStep(10) }>
                    ...
                    <Entry dot={ Entry.DotPosition.TopRight }>
                        <Entry.Text>
                            <strong>Surviving Christmas:</strong> a Yuletide{ ' ' }
                            <em>Gigli</em>?
                        </Entry.Text>
                    </Entry>
                </Scene>
                <Scene onClick={ toggleCurrentStep(11) }>
                    ...
                    <Entry dot={ Entry.DotPosition.Top }>
                        <Entry.Text>
                            <strong>Halloween Parade:</strong> People think it's
                            gross and tacky. (It's still fun.)
                        </Entry.Text>
                ...
                <Scene onClick={ toggleCurrentStep(13) }>
                    ...
                    <Entry
                        ...
                        <Entry.Text>
                            <strong>It's All About Love:</strong> Dogma + indie
                            star power = pretentious glop.
                        </Entry.Text>
                        <PulsingIcon
                            icon={ faHeartBroken }
                            size='3x'
                ...
                <Scene onClick={ toggleCurrentStep(14) }>
                    ...
                    <Entry dot={ Entry.DotPosition.Right }>
                        <Entry.Text>
                            <strong>His Excellency: George Washington</strong>,
                            by <em>Founding Brothers</em> author Joseph J.
                            Ellis.
                        </Entry.Text>
                ...
                <Scene onClick={ toggleCurrentStep(15) }>
                    ...
                    <Entry dot={ Entry.DotPosition.BottomRight }>
                        <Entry.Text>
                            <strong>Ghery</strong> picked for WTC
                ...
                <Scene onClick={ toggleCurrentStep(16) }>
                    ...
                    <Entry dot={ Entry.DotPosition.TopLeft }>
                        <Entry.Text>
                            ...
                            <em>Melrose</em>-like genius, plus a career boost
                ...
                <Scene onClick={ toggleCurrentStep(18) }>
                    ...
                    <Entry dot={ Entry.DotPosition.BottomRight }>
                        <Entry.Text>
                            ...
                            as Boss Hogg in <em>Dukes of Hazzard</em> movie.
                            Toupée makers, rejoice.
                        </Entry.Text>
                        <Image src={ reynolds } />
                    </Entry>
                </Scene>
                ...
                <Scene onClick={ toggleCurrentStep(20) }>
                    ...
                    <Entry dot={ Entry.DotPosition.BottomRight }>
                        <Entry.Text>
                            <strong>Vincent Gallo</strong>, strutting,
                            mutton-chopped Rasputin of indie cinema.
                        </Entry.Text>
                        <Image src={ gallo } />
                    </Entry>
                </Scene>
