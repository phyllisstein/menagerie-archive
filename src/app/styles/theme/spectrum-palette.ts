...
export type SpectrumJSPalette = typeof js

export type SpectrumCSSPalette = {
  [K in keyof SpectrumJSPalette]: string
}

export const css = R.map(R.invoker(0, 'css'), js) as SpectrumCSSPalette
